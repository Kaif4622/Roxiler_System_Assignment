  ...
  return (
    <div className="bg-[#edf6f6]">
      <div className="flex items-center justify-center p-5">
        <div className="w-40 h-40 bg-[rgb(95,61,196)] rounded-full flex items-center justify-center">
      ...
      <DataStats selectedMonth={selectedMonth} />
      <hr className="border border-b-green-500"></hr>
      <DataChart selectedMonth={selectedMonth} />
    </div>
  );
};
